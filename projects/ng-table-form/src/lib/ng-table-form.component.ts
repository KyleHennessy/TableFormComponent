...
@Component({
  selector: 'ng-table-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  styleUrl: './ng-table-form.component.scss',
  templateUrl: './ng-table-form.component.html'
})
export class NgTableFormComponent implements OnInit, AfterViewInit {
